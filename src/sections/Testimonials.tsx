...
export const testimonials = [
    ...
    },
    {
        ...
        name: "Jagadish Pawale",
        title: "Surgeon, Designer",
        image: Jaga,
    },
];
                ...
                <SectionBorder borderTop>
                    <SectionContent>
                        <LayoutGroup>
                            <motion.div
                                layout
                                className="border-gradient rounded-3xl px-6 md:px-10 lg:px-16   py-16  lg:py-24 md:mx-10 lg:mx-20 relative flex flex-col md:flex-row  gap-12 "
                            >
                                <FontAwesomeIcon
                                    icon={faQuoteLeft}
                                    className="text-7xl absolute top-0 -translate-y-1/2 text-violet-400"
                                />
