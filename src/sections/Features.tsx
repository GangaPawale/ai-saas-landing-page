                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2  gap-20">
                            <div>
                                <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold  text-gray-200 leading-tight">
                                    Your AI Collaboration campanion
                                </h2>
                                ...
                                <Button variant="primary" className="mt-16">Try It Now</Button>
                            </div>
                            <div className="flex  justify-center flex-shrink-0">
                                <div className="size-[270px] md:size-[450px] relative flex flex-shrink-0 ">
                                    ...
                                    {logos.map(({ src, alt, rotate }) => (
                                        ...
                                        >
                                            <motion.div
                                                className=" inline-flex size-10 md:size-14 items-center justify-center border border-[var(--border-color )] rounded-lg absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-950"
                                                style={{
                                                    transform: `rotate(-${rotate}deg)`,
                                                }}
                                                initial={{
