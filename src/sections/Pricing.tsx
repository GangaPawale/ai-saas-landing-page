...
export const pricingTiers = [
    ...
    buttonText: string;
    buttonVarient?: ButtonProps["variant"];
    features: string[];
    color: string;
    className: string;
}[];
        ...
        <section className="" id="pricing">
            <div className="container">
                <SectionBorder borderTop>
                    <SectionContent>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center leading-tight text-gray-200">
                                    ...
                                    <ul className="flex flex-col gap-4 mt-8"> 
                                        {tier.features.map((feature) => (
                                            <li key={feature} className="border-t border-[var(--color-border)] pt-4 flex gap-4">
                                                <FontAwesomeIcon icon={faCircleCheck} className="size-6 text-violet-400  flex-shrink-0"/>
